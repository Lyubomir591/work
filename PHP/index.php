...
$arrayWorks = [
    [
        "name_work" => "Менеджер Автострахования",
        "data_start" => "2016",
        "data_end" => "2018",
        "text" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit.
         Iste deserunt iusto cupiditate dolorum optio dolorem repudiandae recusandae dolores magni ut. 
            Obcaecati voluptates quos repellendus quis."
    ],
    [
        "name_work" => "Менеджер по поддержке бизнесса",
        "data_start" => "2020",
        "data_end" => "2021",
        "text" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit.
         Iste deserunt iusto cupiditate dolorum optio dolorem repudiandae recusandae dolores magni ut. 
    ...
    [
        "name_work" => "Менеджер Сохранения Клиентов ",
        "data_start" => "2021",
        "data_end"=>"Досих пор",
        "text" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit.
         Iste deserunt iusto cupiditate dolorum optio dolorem repudiandae recusandae dolores magni ut. 
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <?php for($i = 0; $i < count($arrayWorks);$i++):?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b><?= $arrayWorks[$i]['name_work'] ?> </b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $arrayWorks[$i]["data_start"]?> -
                        <?php if($i == 2 ): ?>
                            <span class="w3-tag w3-teal w3-round">
                                <?= $arrayWorks[$i]["data_end"]?>
                            </span>
                        <?php else:?>
                            <?= $arrayWorks[$i]["data_end"]?>
                        <?php endif?>
                    </h6>
                    <p>-<?php echo $arrayWorks[$i]["text"]?></p>
                    <hr>
                </div>
            <?php endfor; ?>
        </div>
